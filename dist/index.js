(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@babel/runtime/helpers/typeof'), require('express'), require('stream'), require('http')) :
    typeof define === 'function' && define.amd ? define(['exports', '@babel/runtime/helpers/typeof', 'express', 'stream', 'http'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.apinion = {}, global._typeof, global.express, global.stream, global.http));
})(this, (function (exports, _typeof, express, stream, http) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var wsRequest = function (_super) {
      ...
      return wsRequest;
    }(http__namespace.IncomingMessage);
    var wsResponse = function (_super) {
      ...
      wsResponse.prototype.send = function (data) {
        ...
        if (this._header) {
          ...
          this.sock.write('HTTP/1.1 ' + this.statusCode + ' ' + http__namespace.STATUS_CODES[this.statusCode] + '\r\n');
        }
        this.sock.write('\r\n');
      ...
      return wsResponse;
    }(http__namespace.OutgoingMessage);
